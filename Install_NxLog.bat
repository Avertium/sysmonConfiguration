...
nxlog-ce-3.1.2319.msi /quiet
sc failure nxlog actions= restart/10000/restart/10000// reset= 120
@powershell (new-object System.Net.WebClient).DownloadFile('https://raw.githubusercontent.com/TerreVerda/sysmonConfiguration/master/nxlog.conf','C:\Program Files (x86)\nxlog\conf\nxlog.conf')"
