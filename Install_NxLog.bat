...
@powershell (new-object System.Net.WebClient).DownloadFile('https://raw.githubusercontent.com/TerreVerde/sysmonConfiguration/master/nxlog.conf','C:\Program Files (x86)\nxlog\conf\nxlog.conf')"
